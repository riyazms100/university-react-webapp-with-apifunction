...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "fa95ec8f-7370-460a-836a-70da0c736e8b");
    ...
    <div className='contact'>
        <div className="contact-col">
            ...
            <p>Feel free to reach out through contact from or find our contact
                ...
                to us as we strive to provide exceptional serviceto our
                university community.
            </p>
            <ul>
                <li><img src={mail_icon} alt="" />contact@GreatStack.dev</li>
                <li><img src={phone_icon} alt="" />+123 825 855</li>
